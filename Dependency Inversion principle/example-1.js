// https://github.com/SamehEtman/SOLID-Principles-JS/tree/master/Dependency%20Inversion%20Principle
// Definition :
// High level modules should not depend on low level modules; both should depend on abstractions.

// Problem statement :
// We have some people and we want to set the relationship between them and a way to reasearch these realations for simplicity say we have a person called 'john' that has a son called 'chris' we want to record (low level) this relation and find a way to research (high level) it
